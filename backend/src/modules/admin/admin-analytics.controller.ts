...
export class AdminAnalyticsController {
    ...
    @ApiResponse({ status: 200, description: 'Return global KPIs', type: KpisDto })
    async getSummary() {
    ...
    @ApiResponse({ status: 200, description: 'Return business list with deep stats', type: [BusinessAnalyticsItemDto] })
    ...
    @ApiResponse({ status: 200, description: 'Return full dashboard payload', type: AdminDashboardResponseDto })
    async getDashboard() {
