        ...
        <div className="min-h-screen w-full flex bg-[#F5F1E8]">
            ...
            <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:w-[480px] xl:w-[600px] bg-white border-r-2 border-black/10 relative z-10">
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    >
                        <div className="mb-8">
                            <h1 className="text-4xl font-display font-black text-[#1A3D1A] mb-3 tracking-tight">Join MarkMorph</h1>
                            <p className="text-[#1A3D1A]/60 font-medium text-lg">Create your account to get started</p>
                        </div>
                        ...
                        <Form {...signupForm}>
                            <form onSubmit={signupForm.handleSubmit(onSubmit)} className="space-y-5">
                                ...
                                <p className="text-center mt-6 text-sm font-bold text-[#1A3D1A]/60">
                                    ...
                                    <Link href="/login" className="text-[#5B1E5E] underline hover:text-[#1A3D1A]">
                                        Log in
                                    </Link>
                                </p>
                            </form>
            ...
            <div className="hidden lg:flex flex-1 bg-[#1A3D1A] relative overflow-hidden items-center justify-center">
                <NextImage
                    src="/signup-hero.png"
                    alt="Create your digital legacy with MarkMorph"
                    fill
