...
export default function AdminBusinessDetails() {
    const [, match] = useRoute("/admin/business/:id");
    ...
    const { data: business, isLoading, error } = useQuery({
        ...
        enabled: !!businessId && adminApi.isAuthenticated(),
    });
    ...
    const handleViewLogs = async (adId: string) => {
        ...
        try {
            const logs = await adminApi.getAdInteractionDetails(adId);
                    ...
                    <CardContent className="p-0">
                        {business.topPosts && business.topPosts.length > 0 ? (
                            <div className="divide-y divide-gray-100">
                                {business.topPosts.map((post: any, index: number) => (
                        ...
                        <Table>
                            ...
                            <TableBody>
                                ...
                                {interactionLogs.length === 0 && (
                                    <TableRow>
                                        <TableCell colSpan={5} className="text-center py-4">No interaction logs found.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
