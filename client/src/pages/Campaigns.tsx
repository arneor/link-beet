        ...
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Create and manage ads displayed on your splash page.
              </p>
            </div>
            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add a new advertisement to your rotation.
                  </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                  <form
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {campaigns?.map((campaign) => (
              <Card
                key={campaign.id}
                className="overflow-hidden hover:shadow-lg transition-all duration-300 border-border/60 group"
              >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.parentElement?.insertAdjacentHTML(
                        "beforeend",
                        '<div class="text-muted-foreground"><svg class="w-12 h-12" ...><path ...></svg></div>',
                      );
                    }}
                  />
                  {!campaign.contentUrl && (
            ...
            {(!campaigns || campaigns.length === 0) && (
              <div className="col-span-full py-12 text-center border-2 border-dashed rounded-xl bg-gray-50/50">
                ...
                <p className="text-gray-500 max-w-sm mx-auto mt-1 mb-4">
                  Create your first ad to start promoting your business to WiFi
                  users.
                </p>
